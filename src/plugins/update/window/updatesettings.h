...
Q_SIGNALS:
    ...
    void requestSetIdleDownloadConfig(const dcc::update::UpdateModel::IdleDownloadConfig &config);
...
private:
    ...
    dcc::widgets::SwitchWidget *m_onlySecurityUpdates; // 检查安全更新
    dcc::widgets::SwitchWidget *m_systemUpdate; // 检查系统更新
    ...
    QWidget *m_idleTimeDownloadWidget;
